...
shieldcoin={
	init=function(this)
		...
		this.maxtimer=20
		this.cycle=0
		this.state=0 --0: uncollected, 1: collected, 2: all collected
		add(shieldcoins, this)
	end,
	update=function(this)
		if this.collected==true do
			this.state=1
		end
		if allcollected==true do
			this.state=2
		end
		...
		if this.timer<=(this.maxtimer/2) do
			this.cycle=0
		else
			this.cycle=1
		end
		if this.timer==this.maxtimer do
			this.timer=0
		end
		this.timer+=1
	end,
	draw=function(this)
		if this.state==1 do
			pal(12,7)
		elseif this.state==2 do
			pal(12,2)
		end
	
		if this.cycle==1 and this.state==0 do
			this.spr=67
		else
			this.spr=66
		end
...
mapdata={
  ""
}
...

...
77777777000000000511111111111111000000000000000000ee77eee7777e005555555566000660660000006600000066000000660000000066000066000000
...
a9aaaaaa00000000051111111cccccc10000000000000000700bbb0755555555555555550000000000000c000000000000000000000000000000c00000000000
...
__gff__

